...
/**
 * Created by Switcher on 10/14/2015.
 */

// This file contains sample code illustrating how to use the CashDrawerKick class to
// control your cash drawer.  The basic control and status querying mechanisms
// are used here.  For more advanced usage of the CashDrawerKick class, see the
...
public class CashDrawerKick implements StatusUpdateListener, Runnable {
    public static void main(String[] args) {
        new CashDrawerKick().run();
    }
    ...
    public void run() {
        ...
        // instantiate a new jpos.CashDrawerKick object
